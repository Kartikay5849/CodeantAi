...
const SignIn = () => {
    ...
    function SignInOption({ text,icon }) {
        return (
          <button className="bg-white border border-[#D8DAE5] hover:bg-gray-100 text-black py-2 px-8 rounded-md flex justify-center items-center gap-3">
            {icon}{text}
          </button>
        );
      }
  ...
  return (
    <div className="flex  justify-between">
      {/* Left Section */}
        <div className="relative border-1 shadow-xl border-[#e6e6e8] h-screen w-screen flex items-center justify-start">
        <div>
          <div className="  p-6 relative">
            <div className="bg-white shadow-xl ml-12 rounded-2xl p-6 space-y-4">
              <h1 className="text-lg font-bold text-gray-800 flex items-center">
                <span className="mr-2">
                  <svg width="28" height="31" viewBox="0 0 28 31" fill="none" xmlns="http://www.w3.org/2000/svg"></svg>
                </span>
            ...
            <div className="bg-white shadow-2xl  rounded-2xl p-6 mt-12 w-1/2 absolute -bottom-16 -right-16">
            <div className="flex items-center">
                ...
                <div className="ml-4">
                <p className="text-gray-700 text-sm font-medium">Issues Fixed</p>
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="border-1 border-[#000000] shadow-md rounded px-8 pt-6 pb-8">
        {/* Header */}
        <div className="m-20">
          <h1 className="text-3xl text-center">Code & AI</h1>
        ...
        <div className="flex justify-center mb-6">
          <button
            ...
            } font-bold py-2 px-24 rounded-sm focus:outline-none focus:shadow-outline`}
        ...
        >
          {selectedTab === "saas" ? (
            <>
              <SignInOption icon={<FaGithub size={20}/>} text="Sign in with Github" />
              <SignInOption icon={<FaBitbucket color="blue" size={20}/>} text="Sign in with Bitbucket" />
              <SignInOption icon={<VscAzureDevops color="blue" size={20}/>} text="Sign in with Azure DevOps" />
              <SignInOption icon={<FaGitlab color="orange"size={20}/>} text="Sign in with GitLab" />
            </>
          ) : (
            <>
