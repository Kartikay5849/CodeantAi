  ...
  return (
    <div className="flex ">
      <div className=''>
        ...
        <div className="flex-grow p-6 mt-8 md:mt-0 ">
            <div className="flex-grow p-6 bg-gray-50 min-h-screen">
              <div className="flex justify-between items-center mb-6">
                <h1 className="text-xl font-semibold">Repositories</h1>
                <div className="flex items-center space-x-4">
                  <p className="text-gray-600 ml-4">{repositoriesData.length} total repositories</p>
                  <button className="px-2 md:px-4 text-sm md:text-md py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md">
                    Refresh All
                  </button>
                  <button className="px-2 md:px-4 text-sm md:text-md py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md">
                    + Add Repository
                  </button>
                </div>
              </div>
